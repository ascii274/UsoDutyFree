...
public class Anexo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anexo2);

        textViewHead =(TextView) findViewById(R.id.txtVwAnexo2Head);
        textViewContent = (TextView)findViewById(R.id.txtVwAnexo2Content);
